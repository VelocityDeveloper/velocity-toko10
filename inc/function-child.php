...
function velocitychild_theme_setup()
{
	...
	if (class_exists('Kirki')) :
		...
		Kirki::add_panel('panel_toko10', [
			'priority'    => 10,
			'title'       => esc_html__('Toko 10', 'justg'),
...
add_action('justg_header', 'justg_header_toko10');
function justg_header_toko10()
{
	require_once(get_stylesheet_directory() . '/inc/part-header.php');
}
add_action('justg_do_footer', 'justg_footer_toko10');
function justg_footer_toko10()
{
...
add_action('velocitytoko_product_loop','velocitytoko10_content_product',30);
function velocitytoko10_content_product($post){
    ?>
        ...
        <div class="card h-100 card-product overflow-hidden">
            ...
            <div class="card-body text-center position-relative pb-5">
				...
				<div class="position-absolute end-0 start-0 bottom-0 p-3 text-center">
					...
					<?php echo do_shortcode("[beli class='btn btn-sm btn-secondary shadow-sm']"); ?>
				</div>
            </div>
        </div>
    </article><!-- #post-## -->
