<div class="header-top bg-white mb-4">
    <div class="container px-md-0 text-center text-md-start d-md-flex align-items-center justify-content-end">
        ...
        <div class="profile-icons p-0">
            <div class="d-flex justify-content-center justify-content-md-end align-items-center">
                ...
                <div class="py-1">
                    <form action="<?php echo get_site_url(); ?>/products" class="d-flex border" method="get">
